...
kubectl set image deployments/client-deployment server=shreenibrahim/multi-client:$SHA
kubectl set image deployments/worker-deployment server=shreenibrahim/multi-worker:$SHA
